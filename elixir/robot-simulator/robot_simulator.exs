defmodule RobotSimulator do
  ...
  def create(direction \\ :north, {a,b} \\ {0,0}) when direction in @valid_directions and is_integer(a) and is_integer(b) do
  ...
  defp inner_simulate([{:direction, direction}, {:position, position}] = robot, [current | instructions]) when current in @valid_commands do
